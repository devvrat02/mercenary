...
function Terms() {
  return (
    <div className="container terms-page">
      ...
      <p>Welcome to Mercenary!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Gama Softwares's Website, located at www.mercenary.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Mercenary if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Mercenary, you agreed to use
        cookies in agreement with the Gama Softwares's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Gama Softwares and/or its licensors own the
        intellectual property rights for all material on Mercenary. All
        intellectual property rights are reserved. You may access this from
        Mercenary for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Mercenary</li>
        <li>Sell, rent or sub-license material from Mercenary</li>
        <li>Reproduce, duplicate or copy material from Mercenary</li>
        <li>Redistribute content from Mercenary</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Gama
        Softwares does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Gama Softwares,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Gama Softwares
      ...
      <p>
        Gama Softwares reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Gama Softwares a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Gama Softwares; and (d) the
      ...
      <p>
        ...
        e-mail to Gama Softwares. Please include your name, your organization
      ...
      <p>
        No use of Gama Softwares's logo or other artwork will be allowed for

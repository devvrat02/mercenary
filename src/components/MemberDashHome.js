...
class MemberDashHome extends Component {
  constructor(props) {
    super(props);
              ...
              <div className="card UsersStatBox">
                <div className="row">
                  <div className="col-md-4 col-12 py-2">
                    <div className="card dashHomeStatsBox_card">
                      <div className="card-body">
                        <h1 className="dashHomeStatsBox_head">Services Done</h1>
                        <p className="dashHomeStatsBox_lead">
                          {this.addLeadingZeros(this.state.ServicesDone)}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-12 py-2">
                    <div className="card dashHomeStatsBox_card">
                      <div className="card-body">
                        <h1 className="dashHomeStatsBox_head">Ratings</h1>
                        <p className="dashHomeStatsBox_lead">
                          {this.state.Rating}★
                        </p>
                      </div>
                  ...
                  <div className="col-md-4 col-12 py-2">
                    <div className="card dashHomeStatsBox_card">
                      <div className="card-body">
                        ...
                        <p className="dashHomeStatsBox_lead">
                          {this.addLeadingZeros(this.state.ActiveServices)}
                        </p>
                      </div>
                    </div>
                  </div>
